...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <MinusCircle className="text-[#a4a7ae] pointer-events-none size-6 shrink-0 group-data-[state=closed]:hidden" />
        <PlusCircle className="text-[#a4a7ae] pointer-events-none size-6 shrink-0 group-data-[state=open]:hidden" />
      </AccordionPrimitive.Trigger>

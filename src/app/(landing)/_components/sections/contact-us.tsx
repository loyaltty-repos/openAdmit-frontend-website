...
export function ContactUsSection() {
  ...
  const contactCards = [
    {
      title: "Email us",
      description: "Write to us for any questions or comments.",
      value: "contactus@openadmits.com",
      href: "mailto:contactus@openadmits.com",
      icon: Mail,
    },
    {
      title: "Phone us",
      description: "Call us for any questions or comments.",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="space-y-6">
            <div className="rounded-2xl border border-[#E0E4F2] bg-[#072557] p-6 text-white shadow-xl sm:p-8">
              ...
              <Button
                className="mt-6 p-6! bg-[#0056AD] hover:bg-[#0056AD]/90"
                asChild
              >
                <Link href="https://meet.openadmits.com">
                  Book Free Consultation
                </Link>
              </Button>
            </div>
            ...
            <div className="space-y-4">
              {contactCards.map(
                ({ title, description, value, href, icon: Icon }) => (
                  <div
                    key={title}
                    className="flex flex-col gap-4 rounded-xl border border-[#D7E2F1] bg-white p-5 text-[#0F1B29] shadow-sm"
                  >
                    <Icon className="h-5 w-5" />
                    <div className="space-y-1">
                      <p className="text-lg font-semibold">{title}</p>
                      <p className="text-sm text-[#4A5671]">{description}</p>
                    </div>
                    <a
                      href={href}
                      className="text-base font-medium text-[#0056AD] hover:underline"
                    >
                      {value}
                    </a>
                  </div>
